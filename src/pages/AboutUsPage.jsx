      ...
      <div className="flex">
        ...
        <div className="w-1/4 p-4 text-white">
          <div className='pt-4'>
            <ul className='text-black cursor-pointer'>
              <li className='text-2xl font-bold border-b pb-3 text-kesariya border-kesariya cursor-default'>About the University</li>
              ...
              <li
                className="pl-3 text-sm font-normal border border-gray-100 p-4 border-l-4 border-l-red-800 mt-2 shadow-sm hover:bg-amber-300 cursor-pointer"
              ...
              {isGovernanceVisible && (
                <ul className='block w-56   border-l-4 border -mt-0'>
                  <li className="pl-3 text-sm font-normal border border-gray-100  border-l-4 border-l-red-800 p-4 mt-2   shadow-sm hover:bg-amber-300">Chancelar</li>
                  <li className="pl-3 text-sm font-normal border border-gray-100 p-4 mt-2 shadow-sm  border-l-4 border-l-red-800 hover:bg-amber-300">Voice chancelar</li>
                  <li className="pl-3 text-sm font-normal border border-gray-100 p-4 mt-2 shadow-sm  border-l-4 border-l-red-800 hover:bg-amber-300">Core Values</li>
                  <li className="pl-3 text-sm font-normal border border-gray-100 p-4 mt-2 shadow-sm  border-l-4 border-l-red-800 hover:bg-amber-300">Strategic plan</li>
                </ul>
              )}
              ...
              <li className="pl-3 text-sm font-normal border border-gray-100 p-4 border-l-4 border-l-red-800 mt-2 shadow-sm hover:bg-amber-300 ">University in figure</li>
        ...
        <div className="w-3/4 text-black p-4">
          <div className='p-4 border border-gray-200 rounded-md shadow-md'>
            <div>
              <h3 className="text-2xl font-bold border-b pb-3 text-kesariya border-kesariya">Introduction</h3>
              <div className="bg-kesariya w-40 h-1 -mt-0.5 "></div>
            </div>
            ...
            <p className='pt-2 pl-2 font-ro text-black'>
